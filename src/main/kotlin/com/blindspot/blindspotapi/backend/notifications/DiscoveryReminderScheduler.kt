 ...
 * day. Runs on the single free-tier backend instance; safe to run repeatedly since each send is
 * independent and idempotent-ish (worst case, a user gets one extra push if this fires twice
 * in a scaling edge case — acceptable for a low-stakes reminder, unlike the favorites
 * consistency work done earlier). */
@Component
